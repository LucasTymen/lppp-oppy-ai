"""
Crée la landing Promovacances (PPP — rapport audit SEO tourisme) à partir du JSON existant.
Usage : python manage.py create_landing_promovacances [--publish]
...
class Command(BaseCommand):
    help = "Crée la landing Promovacances depuis docs/contacts/promovacances/landing-proposition-promovacances.json"
    ...
    def handle(self, *args, **options):
        json_path = (
            ...
            / "contacts"
            / "promovacances"
            / "landing-proposition-promovacances.json"
        )
        ...
        title = content.get("page_title") or "Lucas Tymen — PPP Promovacances (rapport audit SEO)"
        slug = "promovacances"
        prospect_company = content.get("prospect_company", "Promovacances")
        ...
        self.stdout.write(f"  Dashboard audit : /p/{slug}/audit-dashboard/")
