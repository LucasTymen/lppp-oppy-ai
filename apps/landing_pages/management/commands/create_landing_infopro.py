"""
Crée la landing Infopro Digital (LPPP lppp-infopro) à partir du JSON existant.
Usage : python manage.py create_landing_infopro [--update] [--publish]
...
class Command(BaseCommand):
    help = "Crée la landing Infopro Digital depuis docs/contacts/infopro/landing-proposition-infopro.json"
    ...
    def handle(self, *args, **options):
        json_path = (
            ...
            / "contacts"
            / "infopro"
            / "landing-proposition-infopro.json"
        )
        ...
        title = content.get("page_title") or "Lucas Tymen — LPPP Infopro Digital (audit SEO)"
        slug = "infopro"
        prospect_company = content.get("prospect_company", "Infopro Digital")
        ...
        self.stdout.write(
            "  Export statique : python manage.py export_landing_static infopro --json docs/contacts/infopro/landing-proposition-infopro.json --output deploy/static-infopro-vercel/index.html"
        )
