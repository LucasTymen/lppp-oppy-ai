...
- **Identifiants Flowise** : connexion UI et API via `.env` uniquement (`FLOWISE_USERNAME`, `FLOWISE_PASSWORD`, `FLOWISE_URL`, `FLOWISE_DOCUMENT_STORE_ID`) — ne jamais les committer ; voir `flowise-push-documents-informatique.md` § Identifiants et anti-leak.
