...
- **S'assurer que les logs** (`log-projet.md`, `log-ia.md`) **et le registre erreurs/solutions** (`erreurs-et-solutions.md`) **sont mis à jour** après chaque correction ou session — pour éviter de reproduire les erreurs ; l'**agent en charge des erreurs** (qui assiste le chef de projet) effectue ces mises à jour et **actualise la base de connaissances** (decisions.md, procédures, segmentations, registre agents/ressources) selon le cas ; voir erreurs-et-solutions.md § « Pour l'agent en charge des erreurs ».
