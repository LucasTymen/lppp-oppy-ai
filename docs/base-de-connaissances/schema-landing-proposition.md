...
6. **Ce que j’offre — Mes services pour vous** — Onglets : Rapport SEO, Paid Media (prix récupérateur selon besoins), échantillon de prospects, automatisations et workflows, autres (à définir selon besoins).
...
| `contact_gmail` | Optionnel | URL mailto (ex. `mailto:email@gmail.com?subject=...`) ou lien vers Gmail. Affiche un lien « Gmail » dans la section **Coordonnées** (`#coordonnees`). |
