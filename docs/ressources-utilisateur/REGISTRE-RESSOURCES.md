...
| 2026-02-26 | autres | Base CV / savoir-faire pour candidatures et prospection | `cv_base_datas_pour_candidatures.json` | **Outil pour analyser et prospecter une entreprise** en proposant le savoir-faire. Non utilisé par défaut dans la génération des landings. **Tous les agents** y ont accès pour piocher quand il faut **justifier ou parler du savoir-faire** (LM, email d’approche, argumentaire, fiche entretien). Doc : `docs/base-de-connaissances/cv-base-datas-savoir-faire-prospection.md`. |
